        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Pengecekan Judul Tugas Akhir</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="" method="POST" action="<?php echo base_url('Perhitungan/proses_hitung') ?>">
                                        <div class="mb-3 col-md-8">
                                            <label for="">Judul Tugas Akhir</label>
                                            <input type="text" class="form-control <?= form_error('judul') ? 'is-invalid' : null ?>" id="judul" value="<?php echo set_value('judul'); ?>" name="judul">
